...
1.  **Cloner le projet :**
    ```bash
    git clone [[https://github.com/VOTRE_NOM_UTILISATEUR/NOM_DU_PROJET.git]([https://github.com/Enzooo-dst/TBA](https://github.com/Enzooo-dst/TBA))](https://github.com/VOTRE_NOM_UTILISATEUR/NOM_DU_PROJET.git)
    cd NOM_DU_PROJET
    ```
